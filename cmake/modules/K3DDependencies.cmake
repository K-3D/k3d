...
MACRO(K3D_CHECK_NGUI_DEPENDENCY CONFIG)
	IF(${CONFIG} AND NOT K3D_BUILD_NGUI_MODULE)
		MESSAGE(SEND_ERROR "${CONFIG} requires K3D_BUILD_NGUI_MODULE.")
	ENDIF(${CONFIG} AND NOT K3D_BUILD_NGUI_MODULE)
ENDMACRO()

MACRO(K3D_CHECK_QTUI_DEPENDENCY CONFIG)
	IF(${CONFIG} AND NOT K3D_BUILD_QTUI_MODULE)
		MESSAGE(SEND_ERROR "${CONFIG} requires K3D_BUILD_QTUI_MODULE.")
	ENDIF()
ENDMACRO()
