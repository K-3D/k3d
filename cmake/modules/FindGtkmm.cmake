...
IF(WIN32)
	...
	IF(MSVC)
		SET(K3D_ATKMM_LIB optimized atkmm-1.6 debug atkmm-1.6d CACHE STRING "")
	ELSE(MSVC)
	...
	IF(MSVC)
		SET(K3D_GDKMM_LIB optimized gdkmm-2.4 debug gdkmm-2.4d CACHE STRING "")
	ELSE(MSVC)
	...
	IF(MSVC)
		SET(K3D_GTKMM_LIB optimized gtkmm-2.4 debug gtkmm-2.4d CACHE STRING "")
	ELSE(MSVC)
	...
	IF(MSVC)
		SET(K3D_PANGOMM_LIB optimized pangomm-1.4 debug pangomm-1.4d CACHE STRING "")
	ELSE(MSVC)
