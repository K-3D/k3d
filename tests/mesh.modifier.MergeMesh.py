...
source8 = document.new_node("Newell")
...
testing.mesh_comparison_to_reference(document, modifier.get_property("output_mesh"), "mesh.modifier.MergeMesh", 1, testing.platform_specific)
