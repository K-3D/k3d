...
for type in named_array_types:
	array = polyhedron.face_varying_attributes().create(type, type)

for type in named_array_types:
	array = polyhedron.face_varying_attributes()[type]

for type in named_array_types:
	const_array = polyhedron.face_varying_attributes()[type]
