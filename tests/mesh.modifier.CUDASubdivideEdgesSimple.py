...
testing.output_mesh_difference(cuda_modifier.output_mesh, modifier.output_mesh.pipeline_value(), 1)

difference = testing.get_mesh_difference(document, cuda_modifier.output_mesh.pipeline_value(), modifier.output_mesh, 1)
