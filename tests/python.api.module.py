...
expected_contents = ['__doc__', '__name__', 'almost_equal', 'angle_axis', 'attribute_arrays', 'batch_mode', 'bezier_triangle_patch', 'bicubic_patch', 'bilinear_patch', 'bitmap', 'blobby', 'bounding_box3', 'check_node_environment', 'close_document', 'color', 'command_nodes', 'cone', 'const_attribute_arrays', 'const_bitmap', 'const_named_arrays', 'const_named_attribute_arrays', 'const_nurbs_patches', 'const_polyhedra', 'const_typed_array_bool_t', 'const_typed_array_color', 'const_typed_array_double_t', 'const_typed_array_imaterial', 'const_typed_array_inode', 'const_typed_array_int16_t', 'const_typed_array_int32_t', 'const_typed_array_int64_t', 'const_typed_array_int8_t', 'const_typed_array_matrix4', 'const_typed_array_mesh_polyhedra_t_polyhedron_type', 'const_typed_array_normal3', 'const_typed_array_point2', 'const_typed_array_point3', 'const_typed_array_point4', 'const_typed_array_string_t', 'const_typed_array_texture3', 'const_typed_array_uint16_t', 'const_typed_array_uint32_t', 'const_typed_array_uint64_t', 'const_typed_array_uint8_t', 'const_typed_array_vector2', 'const_typed_array_vector3', 'const_uint_t_array', 'create_plugin', 'cubic_curve', 'cylinder', 'disk', 'documents', 'euler', 'euler_angles', 'execute_script', 'exit', 'file_change_receiver', 'file_signal', 'filesystem', 'get_command_node', 'hyperboloid', 'identity3', 'idocument', 'intersect_lines', 'iunknown', 'length', 'linear_curve', 'log', 'log_critical', 'log_debug', 'log_error', 'log_info', 'log_warning', 'matrix4', 'mesh', 'mesh_selection', 'mime', 'named_arrays', 'named_attribute_arrays', 'new_document', 'normal3', 'nurbs_curve', 'nurbs_patch', 'nurbs_patches', 'open_document', 'paraboloid', 'parallel', 'plugin', 'plugins', 'point_group', 'point2', 'point3', 'point4', 'polyhedra', 'polyhedron', 'polyhedron_type', 'resource', 'ri', 'rotate3', 'scale3', 'selection', 'share_path', 'sphere', 'teapot', 'texture3', 'torus', 'to_vector3', 'translate3', 'typed_array_bool_t', 'typed_array_color', 'typed_array_double_t', 'typed_array_imaterial', 'typed_array_inode', 'typed_array_int16_t', 'typed_array_int32_t', 'typed_array_int64_t', 'typed_array_int8_t', 'typed_array_matrix4', 'typed_array_mesh_polyheda_t_polyhedron_type', 'typed_array_normal3', 'typed_array_point2', 'typed_array_point3', 'typed_array_point4', 'typed_array_string_t', 'typed_array_texture3', 'typed_array_uint16_t', 'typed_array_uint32_t', 'typed_array_uint64_t', 'typed_array_uint8_t', 'typed_array_vector2', 'typed_array_vector3', 'ui', 'uint_t_array', 'uuid', 'vector2', 'vector3', 'vector4']
