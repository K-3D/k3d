...
difference = k3d.difference(modifier.output_matrix, reference_matrix)
...
print """<DartMeasurement name="ULPS" type="numeric/integer">""" + str(difference["ulps"]) + """</DartMeasurement>"""

if difference["ulps"] > 10:
