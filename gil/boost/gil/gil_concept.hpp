...
namespace detail {
    ...
    struct RandomAccessIteratorIsMutableConcept {
        void constraints() {
            ...
            typename std::iterator_traits<TT>::difference_type n; ignore_unused_variable_warning(n);
...
struct RandomAccess2DLocatorConcept {
    void constraints() {
        ...
        x_coord_t xd; ignore_unused_variable_warning(xd);
        y_coord_t yd; ignore_unused_variable_warning(yd);
...
namespace detail {
    ...
    struct RandomAccess2DLocatorIsMutableConcept {
        void constraints() {
            ...
            typename Loc::x_coord_t xd; ignore_unused_variable_warning(xd);
            typename Loc::y_coord_t yd; ignore_unused_variable_warning(yd);
            typename Loc::value_type v;
            loc(xd,yd)=v;
        }
        Loc loc;
...
//        BOOST_STATIC_ASSERT((typename std::iterator_traits< last_it_type>::difference_type, typename point_t::template axis<N-1>::coord_t>::value));
        ...
        difference_type d; ignore_unused_variable_warning(d);
...
namespace detail {
    ...
    struct RandomAccessNDImageViewIsMutableConcept {
        void constraints() {
            ...
            typename View::difference_type diff; ignore_unused_variable_warning(diff);
    ...
    struct RandomAccess2DImageViewIsMutableConcept {
        void constraints() {        
            ...
            typename View::x_coord_t xd; ignore_unused_variable_warning(xd);
            typename View::y_coord_t yd; ignore_unused_variable_warning(yd);
            typename View::value_type v;
            view(xd,yd)=v;
        }
        View view;
