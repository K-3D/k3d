...
/// \brief Specifies the color space type of a pixel. Required by PixelBasedConcept
/// \ingroup PixelModelPixel
template <typename ChannelValue, typename Layout>
...
/// \brief Specifies that the class 'pixel' does not represent a planar pixel. Required by PixelBasedConcept
/// \ingroup PixelModelPixel
template <typename ChannelValue, typename Layout>
struct is_planar<pixel<ChannelValue,Layout> > : public mpl::false_ {};

/// \brief Specifies the color space type of a pixel. Required by HomogeneousPixelBasedConcept
/// \ingroup PixelModelPixel
template <typename ChannelValue, typename Layout>
