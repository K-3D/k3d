...
const_primitive* validate(const mesh& Mesh, const mesh::primitive& Primitive)
{
	...
	try
	{
		...
		return new const_primitive(matrices, materials, start_points, end_points, sweep_angles, selections, constant_attributes, surface_attributes, varying_attributes);
	}
...
primitive* validate(const mesh& Mesh, mesh::primitive& Primitive)
{
	...
	try
	{
		...
		return new primitive(matrices, materials, start_points, end_points, sweep_angles, selections, constant_attributes, surface_attributes, varying_attributes);
	}
	catch(std::exception& e)
	{
		log() << error << e.what() << std::endl;
