...
public:
	cuda_subtract(k3d::iplugin_factory& Factory, k3d::idocument& Document) :
	...
	{
		static k3d::document_plugin_factory<cuda_subtract,
...
k3d::iplugin_factory& cuda_subtract_factory()
{
	return cuda_subtract::get_factory();
}
