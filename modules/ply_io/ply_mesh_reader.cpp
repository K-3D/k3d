...
public:
	...
	{
		static k3d::document_plugin_factory<ply_mesh_reader, k3d::interface_list<k3d::imesh_source > > factory(
...
k3d::iplugin_factory& ply_mesh_reader_factory()
{
	return ply_mesh_reader::get_factory();
}
