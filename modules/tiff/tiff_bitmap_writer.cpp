...
public:
	...
	{
		static k3d::document_plugin_factory<tiff_bitmap_writer,
...
k3d::iplugin_factory& tiff_bitmap_writer_factory()
{
	return tiff_bitmap_writer::get_factory();
}
