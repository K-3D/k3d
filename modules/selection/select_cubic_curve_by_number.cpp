...
public:
	...
	void on_select_mesh(const k3d::dev::mesh& Input, k3d::dev::mesh& Output)
	{
		...
		{
		    k3d::dev::mesh::cubic_curve_groups_t& cubic_curve_groups = *k3d::make_unique(Output.cubic_curve_groups);
		    k3d::dev::mesh::selection_t& curve_selection = *k3d::make_unique(cubic_curve_groups.curve_selection);
