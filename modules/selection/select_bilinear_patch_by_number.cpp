...
public:
	...
	void on_select_mesh(const k3d::dev::mesh& Input, k3d::dev::mesh& Output)
	{
		...
		{
		    k3d::dev::mesh::bilinear_patches_t& bilinear_patches = *k3d::make_unique(Output.bilinear_patches);
		    k3d::dev::mesh::selection_t& patch_selection = *k3d::make_unique(bilinear_patches.patch_selection);
