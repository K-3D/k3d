...
public:
	...
	const k3d::point2 map_3d_to_2d(const k3d::point3& Position, const k3d::bounding_box3& Bounds)
	{
		...
		return k3d::point2(
			...
			(Bounds.py - Position[2]) / (Bounds.depth()));
	}

	static k3d::iplugin_factory& get_factory()
	{
		static k3d::document_plugin_factory<cylinder_map_implementation,
...
/////////////////////////////////////////////////////////////////////////////
// cylinder_map_factory

k3d::iplugin_factory& cylinder_map_factory()
{
	return cylinder_map_implementation::get_factory();
}
