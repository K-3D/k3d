...
public:
	sphere_eversion_implementation(k3d::iplugin_factory& Factory, k3d::idocument& Document) :
		...
		m_document(Document),
		m_time(init_owner(*this) + init_name("time") + init_label(_("Time")) + init_description(_("Eversion Time : between 0 and 1")) + init_value(0.0) + init_constraint(constraint::minimum<double>(0.0, constraint::maximum<double>(1.0))) + init_step_increment(0.01) + init_units(typeid(k3d::measurement::scalar))),
		...
		m_latitudinal_patches(init_owner(*this) + init_name("latitudinal_patches") + init_label(_("Latitudinal patches")) + init_description(_("Latitudinal Patches Per Hemisphere")) + init_value(6) + init_constraint(constraint::minimum<k3d::int32_t>(2)) + init_step_increment(1) + init_units(typeid(k3d::measurement::scalar))),
		m_longitudinal_patches(init_owner(*this) + init_name("longitudinal_patches") + init_label(_("Longitudinal patches")) + init_description(_("Longitudinal Patches Per Strip")) + init_value(4) + init_constraint(constraint::minimum<k3d::int32_t>(2)) + init_step_increment(1) + init_units(typeid(k3d::measurement::scalar))),
		m_strips(init_owner(*this) + init_name("strips") + init_label(_("Strips")) + init_description(_("Strip Number")) + init_value(8) + init_constraint(constraint::minimum<k3d::int32_t>(1)) + init_step_increment(1) + init_units(typeid(k3d::measurement::scalar))),
		m_display_strips(init_owner(*this) + init_name("display_strips") + init_label(_("Display strips")) + init_description(_("Display strip Number")) + init_value(8) + init_constraint(constraint::minimum<k3d::int32_t>(1)) + init_step_increment(1) + init_units(typeid(k3d::measurement::scalar))),
...
private:
	...
	k3d_data(k3d::int32_t, immutable_name, change_signal, with_undo, local_storage, with_constraint, measurement_property, with_serialization) m_latitudinal_patches;
	k3d_data(k3d::int32_t, immutable_name, change_signal, with_undo, local_storage, with_constraint, measurement_property, with_serialization) m_longitudinal_patches;
	k3d_data(k3d::int32_t, immutable_name, change_signal, with_undo, local_storage, with_constraint, measurement_property, with_serialization) m_strips;
	k3d_data(k3d::int32_t, immutable_name, change_signal, with_undo, local_storage, with_constraint, measurement_property, with_serialization) m_display_strips;
