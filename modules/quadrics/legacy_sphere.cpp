...
public:
	legacy_sphere(k3d::iplugin_factory& Factory, k3d::idocument& Document) :
	...
	{
		m_radius.changed_signal().connect(sigc::mem_fun(*this, &legacy_sphere::reset_geometry));
		m_zmin.changed_signal().connect(sigc::mem_fun(*this, &legacy_sphere::reset_geometry));
		m_zmax.changed_signal().connect(sigc::mem_fun(*this, &legacy_sphere::reset_geometry));
		m_thetamax.changed_signal().connect(sigc::mem_fun(*this, &legacy_sphere::reset_geometry));
		...
		add_snap_target(new k3d::snap_target(_("Surface"), sigc::mem_fun(*this, &legacy_sphere::surface_target_position), sigc::mem_fun(*this, &legacy_sphere::surface_target_orientation)));
	}
	...
	{
		static k3d::document_plugin_factory<legacy_sphere,
...
/////////////////////////////////////////////////////////////////////////////
// legacy_sphere_factory

k3d::iplugin_factory& legacy_sphere_factory()
{
	return legacy_sphere::get_factory();
}
