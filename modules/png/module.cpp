...
K3D_MODULE_START(Registry)
	Registry.register_factory(libk3dpng::png_bitmap_importer_factory());
	Registry.register_factory(libk3dpng::png_bitmap_reader_factory());
	Registry.register_factory(libk3dpng::png_bitmap_writer_factory());
K3D_MODULE_END
