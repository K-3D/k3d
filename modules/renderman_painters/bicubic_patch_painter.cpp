...
public:
	...
	void paint_mesh(const k3d::mesh& Mesh, const k3d::ri::render_state& RenderState)
	{
		if(k3d::validate_bicubic_patches(Mesh))
		{
			...
			const k3d::mesh::attribute_arrays_t constant_data = Mesh.bicubic_patches->constant_data;
			const k3d::mesh::attribute_arrays_t uniform_data = Mesh.bicubic_patches->uniform_data;
			const k3d::mesh::indices_t& patch_points = *Mesh.bicubic_patches->patch_points;
			const k3d::mesh::attribute_arrays_t varying_data = Mesh.bicubic_patches->varying_data;
		...
		for(k3d::mesh::primitives_t::const_iterator primitive = Mesh.primitives.begin(); primitive != Mesh.primitives.end(); ++primitive)
		{
			...
			const k3d::mesh::attribute_arrays_t constant_data = bicubic_patch->constant_data;
			const k3d::mesh::attribute_arrays_t uniform_data = bicubic_patch->uniform_data;
			const k3d::mesh::attribute_arrays_t varying_data = bicubic_patch->varying_data;
