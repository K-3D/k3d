...
public:
	...
	{
		m_user_property_changed_signal.connect(sigc::mem_fun(*this, &minimum::mesh_topology_changed));
	}
	...
	void on_create_mesh_topology(k3d::mesh& Mesh)
	{
		...
		// Merge 'em ...
		detail::merge(meshes, m_material.pipeline_value(), k3d::mesh::blobbies_t::MINIMUM, true, Mesh);
	}
