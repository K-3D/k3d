...
public:
	...
	const k3d::matrix4 on_get_element(unsigned long Index1, unsigned long Count1, unsigned long Index2, unsigned long Count2, unsigned long Index3, unsigned long Count3)
	{
		...
		const k3d::axis axis2 = m_axis2.value();
		const k3d::axis axis3 = m_axis3.value();
		...
		k3d::point3 point3(k3d::X == axis3 ? -1 : 1, k3d::Y == axis3 ? -1 : 1, k3d::Z == axis3 ? -1 : 1);
		...
		const k3d::matrix4 matrix3 = (Index3 % 2) ? k3d::scaling3D(point3) : k3d::identity3D();
