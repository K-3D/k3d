...
public:
	sds_gl_face_painter(k3d::iplugin_factory& Factory, k3d::idocument& Document, const k3d::color Unselected = k3d::color(0.2,0.2,0.2), const k3d::color Selected = k3d::color(0.6,0.6,0.6)) :
		...
		m_sds_cache(painter_cache<boost::shared_ptr<const k3d::dev::mesh::points_t>, k3d::sds::k3d_basic_opengl_sds_cache>::instance(Document)),
	...
	void on_paint_mesh(const k3d::dev::mesh& Mesh, const k3d::gl::painter_render_state& RenderState)
	{
		...
		k3d::sds::k3d_basic_opengl_sds_cache* cache = m_sds_cache.get_data(Mesh.points);
		if (!cache)
		{
...
protected:
	painter_cache<boost::shared_ptr<const k3d::dev::mesh::points_t>, k3d::sds::k3d_basic_opengl_sds_cache>& m_sds_cache;
	...
	virtual void select(k3d::sds::k3d_basic_opengl_sds_cache* Cache)
	{
