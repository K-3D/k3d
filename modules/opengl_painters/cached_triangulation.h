#ifndef MODULES_OPENGL_PAINTERS_CACHED_TRIANGULATION_H
#define MODULES_OPENGL_PAINTERS_CACHED_TRIANGULATION_H
...
#endif // !MODULES_OPENGL_PAINTERS_CACHED_TRIANGULATION_H
