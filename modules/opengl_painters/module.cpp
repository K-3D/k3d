...
extern k3d::iplugin_factory& gl_edge_painter_factory();
extern k3d::iplugin_factory& gl_face_painter_factory();
extern k3d::iplugin_factory& gl_point_painter_factory();
...
K3D_MODULE_START(Registry)
	...
	Registry.register_factory(module::opengl::painters::gl_edge_painter_factory());
	Registry.register_factory(module::opengl::painters::gl_face_painter_factory());
	Registry.register_factory(module::opengl::painters::gl_point_painter_factory());
	...
	Registry.register_factory(module::opengl::painters::sds_gl_edge_painter_factory());
	Registry.register_factory(module::opengl::painters::sds_gl_face_painter_factory());
	Registry.register_factory(module::opengl::painters::sds_gl_point_painter_factory());
	Registry.register_factory(module::opengl::painters::sds_vbo_edge_painter_factory());
	Registry.register_factory(module::opengl::painters::sds_vbo_face_painter_factory());
	Registry.register_factory(module::opengl::painters::sds_vbo_point_painter_factory());
