...
public:
	material(k3d::iplugin_factory& Factory, k3d::idocument& Document) :
		...
		m_DisplacementBounds(init_owner(*this) + init_name("displacement_bounds") + init_label(_("Displacement Bounds")) + init_description(_("Displacement bounds")) + init_value(1.0) + init_step_increment(0.1) + init_units(typeid(k3d::measurement::distance))),
